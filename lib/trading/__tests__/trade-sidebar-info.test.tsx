...
describe('trade sidebar evidence labels', () => {
  it('credits the holder count to Jupiter when the ownership audit is unavailable', async () => {
    ...
    expect((await screen.findByRole('tooltip')).textContent).toContain('jupiter-token-api');
  });
