...
export const GET = withApiGateway(
  ...
  try {
    ...
    const timeline = intelligenceStore.getTimeline(tokenIdentity.id);
    ...
    return errorResponse(error instanceof Error ? error : new ApiError('Failed to fetch timeline', 500));
  }
  },
